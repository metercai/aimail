...
import { processInboundMail, routeAddressFromHeaders, verifySignature } from '@aimail/mail-core';
...
export default function piAimail(pi, options = {}) {
    initIdentity();
    const log = {
                ...
                try {
                    ...
                    const toRaw = Array.isArray(payload.to)
                        ...
                        : typeof payload.to === 'string'
                            ? [payload.to]
                            : [];
                    const candidates = routeAddr ? [routeAddr] : toRaw;
                    let cfg;
                    let agentAddr = '';
